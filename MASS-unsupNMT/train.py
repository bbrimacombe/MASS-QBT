...
def get_parser():
    ...
    parser.add_argument("--encoder_mt_random_steps", type=str, default="",
                        help="Encoder random warm up steps")
...
def main(params):
    ...
    for _ in range(params.max_epoch):
        ...
        while trainer.n_sentences < trainer.epoch_size:
            scores = evaluator.run_all_evals(trainer)  # NEW
            # CLM steps
            ...
            if not random_mono and trainer.n_sentences % 5 == 0:
